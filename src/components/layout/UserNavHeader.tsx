    ...
    return (
      <div className="flex items-center gap-2 sm:gap-3">
        <Link
          href="/login"
          prefetch={true}
          className="inline-flex items-center justify-center px-3 py-1.5 sm:py-2 text-xs font-semibold text-slate-700 hover:text-slate-900 bg-slate-100/80 hover:bg-slate-200/80 rounded-lg transition whitespace-nowrap"
        >
          Se connecter
        </Link>
        <Link
          href="/#scan-first"
          prefetch={true}
          className="inline-flex items-center justify-center gap-1.5 px-3.5 py-2 text-xs font-bold text-white bg-blue-600 hover:bg-blue-500 rounded-xl shadow-sm shadow-blue-600/20 transition active:scale-95 whitespace-nowrap cursor-pointer"
        >
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-2 p-1.5 sm:pr-2.5 rounded-xl border border-slate-200/80 bg-white hover:bg-slate-50 transition shadow-2xs cursor-pointer"
