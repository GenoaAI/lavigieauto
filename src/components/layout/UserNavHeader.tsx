    ...
    return (
      <div className="flex items-center gap-2 sm:gap-3">
        <Link
          href="/login"
          prefetch={true}
          className="inline-flex items-center justify-center px-3 py-2 text-xs font-semibold text-slate-600 hover:text-slate-900 transition rounded-lg hover:bg-slate-150/60"
        >
          Se connecter
        </Link>
        <Link
          href="/#scan-first"
          prefetch={true}
          className="inline-flex items-center justify-center gap-1.5 px-3.5 py-2 text-xs font-bold text-white bg-blue-600 hover:bg-blue-500 rounded-xl shadow-sm shadow-blue-600/20 transition active:scale-95"
        >
