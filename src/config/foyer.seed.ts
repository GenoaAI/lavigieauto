...
export const DEFAULT_VEHICLES_SEED: EnrichedVehicle[] = [
  ...
  },
  {
    ...
    vin: "1JCCC87A0BT123456",
    marque: "Jeep",
    modele: "Cherokee (SJ)",
    version: "Chief 4.2L 258ci 4x4",
    annee_mise_en_circulation: 1981,
    date_premiere_immatriculation: "1981-05-10",
    ...
    echeances_previsionnelles: [
      {
        ...
        description: "Entretien préventif moteur vintage AMC 258ci 6 en ligne et graissage des ponts Dana/croisillons.",
